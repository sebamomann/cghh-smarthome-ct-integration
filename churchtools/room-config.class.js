...
const { EventTemperatureMapper } = require("./event-temperature.mapper");
...
class RoomConfiguration {
    ...
    getCurrentRoomTemperature() {
        const lastSentDataManager = new LastSentDataManager({ label: this.homematicName });
        return lastSentDataManager?.lastData?.temperature;
    }
};
