...
const { filterEventsThatEndedInTheLastCronTimeframe, filterEventsThatDidNotStartYet } = require("./event-filter.util");
const { HomematicGroupMapper } = require("./homematic-group.mapper");
...
function handleEventsForIdleAdjustments(events) {
    const filteredEvents = filterEventsThatEndedInTheLastCronTimeframe(events);
